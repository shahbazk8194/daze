...
class Head(Element):
    ...
    def drawText(self, event, qp):
        ...
        # str(self.main.min())
        da_min = str(datetime.timedelta(seconds=self.main.min()))
        qp.drawText(event.rect(), QtCore.Qt.AlignLeft, da_min)
...
class Tail(Element):
    ...
    def drawText(self, event, qp):
        ...
        qp.setFont(QtGui.QFont('Arial', 10))
        # str(self.main.max())
        da_max = str(datetime.timedelta(seconds=self.main.max()))
        qp.drawText(event.rect(), QtCore.Qt.AlignRight, da_max)
...
class Handle(Element):
    ...
    def drawText(self, event, qp):
        qp.setPen(self.textColor())
        qp.setFont(QtGui.QFont('Arial', 10))
        da_min = str(datetime.timedelta(seconds=self.main.start()))
        da_max = str(datetime.timedelta(seconds=self.main.end()))
        qp.drawText(event.rect(), QtCore.Qt.AlignLeft, da_min)
        qp.drawText(event.rect(), QtCore.Qt.AlignRight, da_max)
        self.min_val = str(self.main.start())
        self.max_val = str(self.main.end())
...
class QRangeSlider(QtWidgets.QWidget, UIForm):
    ...
    startValueChanged = QtCore.pyqtSignal(int)
    endValueChanged = QtCore.pyqtSignal(int)
    start_changed = QtCore.pyqtSignal(int)
    end_changed = QtCore.pyqtSignal(int)
